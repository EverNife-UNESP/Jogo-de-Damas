...
public class PieceStackPane extends StackPane {
    ...
    public SquareField calculateTargetSquareField(int xDislocation, int yDislocation){
        ...
        int dislockX = (xDislocation / TAMANHO_QUADRADO) + (xDislocation % 100 > (TAMANHO_QUADRADO/2) ? 1 : 0);
        int dislockY = (yDislocation / TAMANHO_QUADRADO) + (yDislocation % 100 > (TAMANHO_QUADRADO/2) ? 1 : 0);// + (yDislocation % 100 < -50 ? 1 : 0);;
